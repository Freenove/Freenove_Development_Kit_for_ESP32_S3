...
void lv_example_calendar_1(void)
{
  ...
  lv_calendar_set_today_date(calendar, 2022, 9, 9);
  ...
  highlighted_days[2].month = 9;
  highlighted_days[2].day = 22;

  lv_calendar_set_highlighted_dates(calendar, highlighted_days, 3);//设置日期高亮显示
